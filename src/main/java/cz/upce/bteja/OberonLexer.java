...
public class OberonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "ARRAY", "MATRIX", "OF", 
			"END", "TO", "PROCEDURE", "DIV", "MULT", "MOD", "PLUS", "MINUS", "IF", 
			"THEN", "ELSIF", "ELSE", "FOR", "DO", "BY", "BEGIN", "RETURN", "CONST", 
			"VAR", "MODULE", "EXIT", "STRING", "IDENT", "LETTER", "INTEGER", "REAL", 
			"WS"
		};
	}
